            ...
            <div class="col-lg-8 ftco-animate">
                <div class="row">
                    <div class="col-md-12 d-flex ftco-animate">
                        <div class="blog-entry align-self-stretch d-md-flex">
                            <a href="blog-single.php" class="block-20"
                                style="background-image: url('images/dabulla.jpg');">
                            </a>
                            <div class="text d-block pl-md-4">
                                ...
                                <p>We facilitate you to monitor the price of vegetables in Dabulla Economic Center
                                    daily.</p>
                    ...
                    <div class="col-md-12 d-flex ftco-animate">
                        <div class="blog-entry align-self-stretch d-md-flex">
                            <a href="blog-single.php" class="block-20"
                                style="background-image: url('images/Tabuthegama.jpg');">
                            </a>
                            <div class="text d-block pl-md-4">
                                <div class="meta mb-3">
                                    <div><a href="#">July 20, 2019</a></div>
                        ...
                        <div class="col-md-12 text-center">
                            ...
                            <p>
                                ...
                                document.write(new Date().getFullYear());
                                    ...
                                    href="https://colorlib.com" target="_blank">HAPPYFARMER</a>
                                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                            </p>
                        </div>
                    </div>
