...
<section class="ftco-section">
                ...
                <ul class="product-category">
                    <li>
                        <a href="Vegetables.php"
                            style="display: inline-block; padding: 10px 20px; background-color: #82ae46; color: #fff; text-decoration: none; border-radius: 12px; transition: background-color 0.3s;">
                            Vegetables
                        </a>
                    </li>
    ...
    if (isset($_GET['search'])) {
        ...
        $result = mysqli_query($conn, "SELECT * FROM products WHERE type = 'vegetables' AND name LIKE '%$searchTerm%'");
    } else {
        $result = mysqli_query($conn, "SELECT * FROM products WHERE type = 'vegetables'");
