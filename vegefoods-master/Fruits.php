...
<section class="ftco-section">
        ...
        <div class="row justify-content-center">
            <div class="col-md-10 mb-5 text-center">
                <ul class="product-category">
                    ...
                    <li>
                        <a href="Fruits.php"
                            style="display: inline-block; padding: 10px 20px; background-color: #82ae46; color: #fff; text-decoration: none; border-radius: 12px; transition: background-color 0.3s;">Fruits</a>
                    </li>
   ...
   if (isset($_GET['search'])) {
    ...
    $result = mysqli_query($conn, "SELECT * FROM products WHERE type = 'fruits' AND name LIKE '%$searchTerm%'");
} else {
    $result = mysqli_query($conn, "SELECT * FROM products WHERE type = 'fruits'");
